...
root= Tk()
root.title("It's Vrushali Alarm Project")
...
submit = Button(panel,text="Submit",font=('comic sans',20),command=th)
submit.grid(row=3,column=1,columnspan=2,padx=10,pady=5)
